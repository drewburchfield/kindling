...
**Purpose:** Staging area for AI-generated insights. Everything here needs human review before it becomes permanent.
...
5. Run `/de-ai-ify` if needed
6. Promote to `02_Permanent/` or delete

**What does NOT go here:**
- Your original writing (goes directly to `02_Permanent/`)
- Source summaries (go to `01_Sources/`)
